        ...
        <div class="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
            ...
            <div class="flex flex-row items-center justify-end gap-1">
                ...
                <button type="button"
                    ...
                    <span
                        class="absolute top-1 end-0 inline-flex items-center py-0.5 px-1.5 me-3 rounded-full text-xs font-medium transform -translate-y-1/2 translate-x-1/2 bg-red-500 text-white">0</span>
                </button>
...
<div id="hs-offcanvas-right"
    ...
    <div class="p-4">
        ...
        <div class="flex flex-col items-center justify-center mt-5">
            ...
            <h1 class="mt-2 dark:text-neutral-50 font-semibold">No notifications</h1>
