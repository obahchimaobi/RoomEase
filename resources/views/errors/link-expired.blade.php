...
@section('content')
    <div class="flex flex-col mx-auto size-full items-center h-screen justify-center relative bg-gradient-to-bl from-blue-100 via-transparent dark:from-blue-950 dark:via-transparent">
        <!-- ========== HEADER ========== -->
        ...
        <main id="content">
            <div class="text-center py-10 px-4 sm:px-6 lg:px-8">
                ...
                <p class="mt-3 text-gray-600 dark:text-neutral-400">The password reset link is invalid or has expired.</p>
