                ...
                <div class="text-center">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-neutral-400">
                        ...
                        <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500"
                            href="{{ route('landlord.register') }}" wire:navigate>
                            Sign up here
                        </a>
                    </p>
                </div>
        ...
        autofill:pb-2"
          ...
          peer-[:not(:placeholder-shown)]:text-gray-500 dark:peer-[:not(:placeholder-shown)]:text-neutral-500 dark:text-neutral-500">Password</label>
                    ...
                    <div class="mt-5 flex items-center justify-between">
                        ...
                        <a class="text-blue-600 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500" href="{{ route('landlord.forgot.password') }}" wire:navigate>Forgot Password?</a>
                    </div>
                    <!-- End Checkbox -->
