...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div class="mb-7 flex items-center justify-between">
            ...
            <select
                class="py-2 px-3 pe-9 block w-36 border-gray-200 rounded-full text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-blue-600">
        ...
        <section
            class="flex flex-row gap-7 pb-1 sm:pb-5 md:pb-5 lg:pb-5 xl:pb-5 text-center overflow-x-scroll [&::-webkit-scrollbar]:h-0
  ...
  [&::-webkit-scrollbar-track]:rounded-full">
    ...
    <!-- Testimonials -->
    <div class="overflow-hidden bg-gray-800 dark:bg-neutral-950 mt-7">
        <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            <!-- Title -->
            <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-11">
                <h2 class="text-2xl sm:text-3xl lg:text-4xl text-white font-semibold">
                    What do they say about RoomEase
                </h2>
            </div>
            <!-- End Title -->
