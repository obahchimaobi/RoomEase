...
<head>
    ...
    <title>RoomEase - @yield('title', 'Home')</title>
...
<body class="dark:bg-neutral-950 font-inter text-sm">
    <!-- ========== HEADER ========== -->
    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div class="mb-7">
            <h1 class="dark:text-neutral-200 font-semibold text-3xl">Available Rooms</h1>
        </div>
        <section
  ...
  [&::-webkit-scrollbar-track]:rounded-full">
    ...
    <!-- ========== FOOTER ========== -->
    <footer class=" bg-neutral-900 w-full dark:bg-neutral-950 mt-5">
